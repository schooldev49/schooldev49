```asm
msg db	'hi im schooldev49',0xa
```

Note: most commits on my GITHUB are not synced at the moment for a long time due to some issues... also trying to sync my website back since Vercel has some issues
